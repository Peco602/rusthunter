...
```console
PS C:\Users\user\rusthunter-main> .\rusthunter.ps1 compare -FilterHost 192.168.1.102 -FilterPlugin windows_tcp_listen -ShowStatistics
...
Get the difference details via filtering by host and plugin (use the `-FilterHost` and `-FilterPlugin` parameters):

```console
PS C:\Users\user\rusthunter-main> .\rusthunter.ps1 compare -FilterHost 192.168.1.102 -FilterPlugin windows_tcp_listen -InitialSnapshot .\PRE-PATCHING_20220410-131824.json -CurrentSnapshot .\POST-PATCHING_20220420-121525.json
